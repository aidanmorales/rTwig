...
**Aidan Morales**, and **David W. MacFarlane**. “rTwig: An R package to
correct overestimated small branches and twigs in quantitative structure
models of trees” *Science of Remote Sensing*, 2025, *12*, 100284.
<https://doi.org/10.1016/j.srs.2025.100284>
...
![](reference/figures/WO18_comparison.png)

#### Efficient Visualization

[`plot_qsm()`](https://aidanmorales.github.io/rTwig/reference/plot_qsm.md)
can plot QSMs and point clouds, using `rgl` as the 3D display, and C++
via `Rcpp` to efficiently build the cylinders. The cylinders, simulated
point cloud, and skeleton can all be plotted and colored by any variable
...
it easy to combine and analyze QSMs from different sources.
[`tree_metrics()`](https://aidanmorales.github.io/rTwig/reference/tree_metrics.md)
calculates all of the major QSM metrics between all supported software.
[`prune_qsm()`](https://aidanmorales.github.io/rTwig/reference/prune_qsm.md)
can virtually prune a tree using multiple input parameters.
[`cluster_cloud()`](https://aidanmorales.github.io/rTwig/reference/cluster_cloud.md)
can transfer all QSM metrics directly onto an unorganized point cloud,
or simulate a virtual point cloud. See the vignettes or function
reference pages for more details.

![](reference/figures/crown_3d.png)
...
![](reference/figures/box_dimension3d.png)
