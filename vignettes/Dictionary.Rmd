...
**`branch_length_min_m:`** The shortest branch length in the tree in meters.

**`branch_length_max_m:`** The longest branch length in the tree in meters.

**`branch_length_mean_m:`** The average branch length in the tree in meters.

**`branch_length_sd_m:`** The standard deviation of the branch length in the tree in meters.

**`branch_length_gini:`** The Gini coefficient of the branch lengths in the tree in meters.

**`branch_volume_min_m3:`** The shortest branch volume in the tree in cubic meters.

**`branch_volume_max_m3:`** The longest branch volume in the tree in cubic meters.

**`branch_volume_mean_m3:`** The average branch volume in the tree in cubic meters.

**`branch_volume_sd_m3:`** The standard deviation of the branch volume in the tree in cubic meters.

**`branch_volume_gini:`** The Gini coefficient of the branch volumes in the tree in cubic meters.

**`branch_alt_length_min_m:`** The shortest branch_alt length in the tree in meters.

**`branch_alt_length_max_m:`** The longest branch_alt length in the tree in meters.

**`branch_alt_length_mean_m:`** The average branch_alt length in the tree in meters.

**`branch_alt_length_sd_m:`** The standard deviation of the branch_alt length in the tree in meters.

**`branch_alt_length_gini:`** The Gini coefficient of the branch_alt lengths in the tree in meters.

**`branch_alt_volume_min_m3:`** The shortest branch_alt volume in the tree in cubic meters.

**`branch_alt_volume_max_m3:`** The longest branch_alt volume in the tree in cubic meters.

**`branch_alt_volume_mean_m3:`** The average branch_alt volume in the tree in cubic meters.

**`branch_alt_volume_sd_m3:`** The standard deviation of the branch_alt volume in the tree in cubic meters.

**`branch_alt_volume_gini:`** The Gini coefficient of the branch_alt volumes in the tree in cubic meters.
...
**`path_length_sd_m:`** The standard deviation of the path lengths in the tree in meters.

**`path_length_gini:`** The Gini coefficient of the path lengths in the tree in meters.
...
**`crown_projected_alpha_area_m2:`** The projected crown area from an alpha shape in square meters.
...
**`crown_area_m2:`** The surface area of the crown from a convex hull in square meters.

**`crown_volume_m3:`** The volume of the crown from a convex hull in cubic meters.

**`crown_alpha_area_m2:`** The surface area of the crown from an alpha shape in square meters.

**`crown_alpha_volume_m3:`** The volume of the crown from an alpha shape in cubic meters.
...
**`dbh_tri_cm:`** The diameter of the triangulation nearest to breast height.

**`tri_volume_m3:`** The volume of the triangulation mesh in cubic meters.

**`stem_mix_volume_m3:`** The mixed volume of the triangulation mesh and stem above the mesh in cubic meters.

**`tree_mix_volume_m3:`** The mixed volume of the triangulation mesh and tree above the mesh in cubic meters.

**`tri_area_m2:`** The area of the triangulation mesh in square meters.

**`stem_mix_area_m2:`** The mixed area of the triangulation mesh and stem above the mesh in square meters.

**`tree_mix_area_m2:`** The mixed area of the triangulation mesh and tree above the mesh in square meters.

**`tri_length_m:`** The vertical length of the triangulation mesh in meters. 
