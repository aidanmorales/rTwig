...
#' vignette for a detailed description of column names. A consistent format
#' between is designed to ensure maximum compatibility when analyzing QSMs  made
#' with different software. This function can be run either before or after
#' the update_cylinders function has been run, or at any stage.
#'
  ...
  # SimpleForest ---------------------------------------------------------------
    ...
    cylinder <- cylinder %>%
      select(
        ...
        axis_x = "axisY", axis_y = "axisY", axis_z = "axisZ",
