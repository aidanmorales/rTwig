...
**`branch_length_sd_m:`** The standard deviation of the branch length in
the tree in meters.

**`branch_length_gini:`** The Gini coefficient of the branch lengths in
the tree in meters.

**`branch_volume_min_m3:`** The shortest branch volume in the tree in
cubic meters.

**`branch_volume_max_m3:`** The longest branch volume in the tree in
cubic meters.

**`branch_volume_mean_m3:`** The average branch volume in the tree in
cubic meters.

**`branch_volume_sd_m3:`** The standard deviation of the branch volume
in the tree in cubic meters.

**`branch_volume_gini:`** The Gini coefficient of the branch volumes in
the tree in cubic meters.

**`branch_alt_length_min_m:`** The shortest branch_alt length in the
tree in meters.

**`branch_alt_length_max_m:`** The longest branch_alt length in the tree
in meters.

**`branch_alt_length_mean_m:`** The average branch_alt length in the
tree in meters.

**`branch_alt_length_sd_m:`** The standard deviation of the branch_alt
length in the tree in meters.

**`branch_alt_length_gini:`** The Gini coefficient of the branch_alt
lengths in the tree in meters.

**`branch_alt_volume_min_m3:`** The shortest branch_alt volume in the
tree in cubic meters.

**`branch_alt_volume_max_m3:`** The longest branch_alt volume in the
tree in cubic meters.

**`branch_alt_volume_mean_m3:`** The average branch_alt volume in the
tree in cubic meters.

**`branch_alt_volume_sd_m3:`** The standard deviation of the branch_alt
volume in the tree in cubic meters.

**`branch_alt_volume_gini:`** The Gini coefficient of the branch_alt
volumes in the tree in cubic meters.

**`segments:`** The total number of segments in the QSM.
